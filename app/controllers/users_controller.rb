class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:username, :first_name, :last_name, :password, :password_confirmation, :location, :email_address, :description, :phone_number, :avatar, :properties)
  end
end